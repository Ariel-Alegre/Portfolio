...
return(
    <div className={styles.projectContainer}>
        <div class="col-xs-12">
         <h2 id='portfolio' className={styles.titlePortfolio}>P O R T F O L I O</h2>
    ...
    <div className={styles.projects}> 
    <h3 className={styles.title}>Videos Juegos</h3>
            <a href="https://videos-juegos.vercel.app/" target='_blank' rel="noreferrer">
            <img src={image} className={styles.img}  alt="not found" />
            </a>
            <div className=''>
            <a href="https://github.com/Ariel-Alegre/Videos-Juegos" target='_blank' rel="noreferrer">
                <BsGithub className={styles.icons}/>
                </a>
            </div>
        </div>
    ...
    <h3 className={styles.title}>Countries</h3>          
          <a href="https://countries-odezfvq49-ariel-alegre.vercel.app/" target='_blank' rel="noreferrer">
          <img src={country} className={styles.img} alt="not found" />
           </a>
           <div className=''>
            <a href="https://github.com/Ariel-Alegre/Countries" target='_blank' rel="noreferrer">
                <BsGithub className={styles.icons}/>
                </a>
            </div>
        </div>
